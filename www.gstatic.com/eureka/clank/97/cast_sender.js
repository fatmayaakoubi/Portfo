(function() {
    ...
    */
    ...
    var Ga = function(a) {
        ...
        Ha = new B(t.trustedTypes && t.trustedTypes.emptyHTML || "", 0, Fa);
    var Ia = {
            MATH: !0,
            SCRIPT: !0,
            STYLE: !0,
    ...
    f.rc = function(a, b, c) {
        0 > Na(this, a) || C.s(this, "QUEUE_REMOVE", new chrome.cast.media.ya([a]), b, c, chrome.cast.media.timeout.A)
    };
    f.tc = function(a, b, c) {
    ...
    f.Va = function(a, b, c) {
        a.Pa(new Qa(this.sessionId), b, c, chrome.cast.timeout.stopSession)
    };
    f.sendMessage = function(a, b, c, d) {
        this.Ra(C, a, b, c, d)
    };
    f.Ra = function(a, b, c, d, e) {
        a.Ac(new Oa(this.sessionId, b, c), d, e)
    };
    f.ba = function(a) {
        this.O(C, a)
    };
    ...
    f.keys = function() {
        return Za(this.u(!0)).j()
    };
    f.values = function() {
        return Za(this.u(!1)).j()
    };
    f.entries = function() {
        var a = this;
    ...
    P.prototype.connect = function(a) {
        ...
        db(this, new O("client_connect", this.j))
    };
    ...
    var gb = function(a, b, c, d, e, h, k, l, p, r, nb, ob) {
            this.L = a;
            this.g = b || null;
            this.l = c || null;
            this.C = d || null;
        ...
        hb = function(a) {
            ...
            a.j && b.push(fb(new eb(a.j, a.K, a.g)));
            return b
        };
    var ib = function() {
            this.g = {};
    ...
    var pb = -1 != A.indexOf("Gecko") && !(-1 != A.toLowerCase().indexOf("webkit") && -1 == A.indexOf("Edge")) && !(-1 != A.indexOf("Trident") || -1 != A.indexOf("MSIE")) && -1 == A.indexOf("Edge"),
        qb = -1 != A.toLowerCase().indexOf("webkit") && -1 == A.indexOf("Edge");
    try {
    ...
    R.prototype.B = function(a) {
        this.m = arguments;
        this.g || this.l ? this.j = !0 : sb(this)
    };
    ...
    R.prototype.resume = function() {
        this.l--;
        this.l || !this.j || this.g || (this.j = !1, sb(this))
    };
    var sb = function(a) {
        a.g = rb(function() {
            a.g = null;
    ...
    var tb = {},
        S = null,
        ub = pb || qb || "function" == typeof t.btoa,
        vb = function(a) {
            if (ub) var b = t.btoa(a);
            else {
                b = [];
    ...
    var V = function() {
        ...
        W = function(a, b, c, d) {
            ...
            d = db(a.B, b);
            c && d && (a =
                cb(a.M, b.sequenceNumber), b = new chrome.cast.Error(chrome.cast.D.INVALID_PARAMETER, d), (a = a.g) && a(b))
        };
    ...
    var Y = function(a, b, c) {
            ...
            b.onclose = function(d) {
                ...
                switch (d.reason) {
                    case "closed":
                        yb(a, chrome.cast.N.DISCONNECTED);
                        break;
                    case "error":
        ...
        Bb = function(a) {
            var b = Z;
            zb.has(a.type) && b.ma && (b.m ? (a.sessionId = b.m, Ab(b, null, a.type, a, function() {}, function() {})) : b.kb.B(X(b, void 0, "urn:x-cast:com.google.cast.media",
                a)))
        };
    ...
    V.prototype.requestSession = function(a, b, c) {
        var d = this;
        this.l ? xb(b) : (c = X(this, c), this.l = a, (new PresentationRequest(c)).start().then(function(e) {
            Y(d, e, b)
        }).catch(function(e) {
            d.l = null;
    ...
    var X = function(a, b, c, d) {
        var e = null,
            ...
            l = k.dialRequest;
        l && (e = l.appName, (h = l.launchParameter) && !h.match(Cb) && (h = vb(h)));
        var p = [];
        p.push({
            appId: k.appId,
        ...
        return hb(new gb(p, a.B.j, a.g.autoJoinPolicy, a.g.defaultActionPolicy, k.requestSessionTimeout, e, h, a.g.invisibleSender, c, d, k.androidReceiverCompatible, k.credentialsData))
    };
    V.prototype.Qa = function(a, b, c, d) {
        var e = this;
        this.F++;
        Ab(this, null, b, a, function(h) {
            e.F--;
            h.l = !0;
            c && c(h)
        }, function(h) {
    ...
    V.prototype.s = function(a, b, c, d, e, h) {
        var k = this;
        Ab(this, a, b, c, function(l) {
            k.Ia(l);
            d && d(void 0)
        }, e, h)
    };
    var Ab = function(a, b, c, d, e, h, k) {
        d.type = c;
    ...
    var yb = function(a, b) {
        if (a.m) {
            ...
            jb(a.I, c, b) && (M(a.v, c), M(a.K, c), b = a.C.get(c)) && (M(a.C, c), F(b.u(), function(e) {
                e(d)
            }))
        }
    };
    V.prototype.onMessage = function(a) {
        switch (a.type) {
            case "new_session":
            case "update_session":
                a.message = lb(this.I, a.message);
                break;
            case "v2_message":
                var b = a.message;
                b && "MEDIA_STATUS" == b.type && b.status && (b.status = b.status.map(this.lb))
        }
        if (b = cb(this.M, a.sequenceNumber)) "error" == a.type ? (b = b.g) && b(a.message) : (b = b.l) && b(a.message);
    ...
    chrome.cast.unescape = function(a) {
        return -1 != a.indexOf("&") ? "document" in t ? La(a) : Ma(a) : a
    };
